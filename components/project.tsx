        ...
        <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          <h3 className="text-2xl font-semibold group">
            <a
                ...
                className="text-gray-700 group-hover:underline dark:text-white/70"
              >{title}<FaExternalLinkAlt className="inline invisible group-hover:visible ml-1 text-sm mb-2" />
            </a>
          </h3>
